...
export default function PartnersPage() {
  ...
  const [activePid, setActivePid] = useState(null);         // selected partner for ledger tab
  ...
  // auto-select first partner for ledger tab
  useEffect(() => {
  ...
  return (
    <>
      ...
      <div style={{ display: 'flex', gap: 0, marginBottom: 20, borderBottom: '2px solid var(--border)' }}>
        ...
        <button style={TAB_STYLE(tab === 'ledger')}    onClick={() => setTab('ledger')}>📒 Ledger</button>
        ...
        <>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: `repeat(${partners.length + 1}, 1fr)`, gap: 12, marginBottom: 20 }}>
            ...
            <div className="card" style={{ borderTop: '3px solid var(--muted)', padding: '16px 18px', background: 'var(--light)' }}>
              <div style={{ fontWeight: 800, fontSize: 13, color: 'var(--muted)', marginBottom: 10, textTransform: 'uppercase', letterSpacing: '.05em' }}>Combined</div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 13 }}>
                  <span style={{ color: 'var(--muted)' }}>Total Invested</span>
          ...
          <div className="card">
            <div className="card-hd">Record Transaction</div>
            ...
            <div className="row mt12">
              <button className="btn btn-primary" onClick={saveTransaction} disabled={!form.partner_id || !form.amount}>Save</button>
